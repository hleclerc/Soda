...
struct AllocFactory : public Allocator {
    ...
    struct Factory_3 {
        Factory_3( Allocator *l, T0 a0, T1 a1, T2 a2 ) : l( l ), a0( a0 ), a1( a1 ), a2( a2 ) {}
        template<class TI> operator TI *() {
            if ( sizeof( TI ) >= 4 )
                l->align( N<4>() );
    ...
    struct Factory_4 {
        Factory_4( Allocator *l, T0 a0, T1 a1, T2 a2, T3 a3 ) : l( l ), a0( a0 ), a1( a1 ), a2( a2 ), a3( a3 ) {}
        template<class TI> operator TI *() {
            if ( sizeof( TI ) >= 4 )
                l->align( N<4>() );
    ...
    /// ex : int *a = local_mem_alloc.factory( 10.5 ); -> will produce an int with value 10
    template<class T0,class T1,class T2>
    Factory_3<T0,T1,T2> factory( T0 a0, T1 a1, T2 a2 ) {
        return Factory_3<T0,T1,T2>( this, a0, a1, a2 );
    }

    /// ex : int *a = local_mem_alloc.factory( 10.5 ); -> will produce an int with value 10
    template<class T0,class T1,class T2,class T3>
    Factory_4<T0,T1,T2,T3> factory( T0 a0, T1 a1, T2 a2, T3 a3 ) {
